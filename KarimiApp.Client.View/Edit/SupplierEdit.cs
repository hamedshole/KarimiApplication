...
{
    public partial class SupplierEdit : DevExpress.XtraEditors.XtraForm
    {
        ...
        public SupplierEdit()
        {
            ...
            this.unitOfWork.SupplierCompany.List(this.ComboBoxSupplierCompany);
        ...
        public SupplierEdit(PersonModel person)
        {
            this.cultureInfo = new System.Globalization.CultureInfo("fa-IR");
        ...
        private SupplierAgentModel GetValuesCreate()
        {
            return new SupplierAgentModel(personGroup: "تامین کننده", company: ComboBoxSupplierCompany.Text, name: this.TextBoxFirstName.Text, mobileNumber: this.TextBoxPhoneNumber.Text, address: TextBoxAddress.Text);
        }

        private PersonModel GetValuesUpdate()
        {
            return new SupplierAgentModel(personGroup: "تامین کننده", company: ComboBoxSupplierCompany.Text, id: Convert.ToInt32(this.TextBoxId.Text, this.cultureInfo), name: this.TextBoxFirstName.Text, mobileNumber: this.TextBoxPhoneNumber.Text, address: TextBoxAddress.Text);
        }
        ...
        private void ButtonSupplierCompanyNew_Click(object sender, EventArgs e)
        {
            SupplierCompanyEdit supplierCompany = new SupplierCompanyEdit();
