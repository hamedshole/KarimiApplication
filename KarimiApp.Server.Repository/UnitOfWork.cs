    ...
    public class UnitOfWork
    {
        ...
        public IDiscount Discount
        {
            get
            {
                ...
                {
                    _discountRepository = new DiscountRepository(this.dbCommand);
                }
        ...
        public IInventoryManagement InventoryManagement
        {
            get
            {
                ...
                {
                    _inventoryManagement = new InventoryManagementRepository(this.dbCommand);
                }
